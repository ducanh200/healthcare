                                ...
                                <table class="table table-hover table-center mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="product-description.html" class="avatar avatar-sm me-2"><img class="avatar-img" src="assets/img/products/product.jpg" alt="User Image"/></a>
                                                </h2>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="product-description.html" class="avatar avatar-sm me-2"><img class="avatar-img" src="assets/img/products/product1.jpg" alt="User Image"/></a>
                                                </h2>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="product-description.html" class="avatar avatar-sm me-2"><img class="avatar-img" src="assets/img/products/product2.jpg" alt="User Image"/></a>
                                                </h2>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="product-description.html" class="avatar avatar-sm me-2"><img class="avatar-img" src="assets/img/products/product3.jpg" alt="User Image"/></a>
                                                </h2>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="product-description.html" class="avatar avatar-sm me-2"><img class="avatar-img" src="assets/img/products/product4.jpg" alt="User Image"/></a>
                                            </h2>
